...
export class CareerComponent {
  ...
  constructor() {
    this.jobs = [
      { company: 'NRECA', title: 'Sr. Software Developer (IV)', timeframe: 'Sept 2023 to Present', description: 'Lead developer on agile software development team responsible for all aspects of software development lifecycle and maintenance of portfolio of custom web applications to support business functions. Responsibilities include architecting full-stack solutions from conception to deployment, including management of cloud infrastructure and DevSecOps pipelines, as well as production workload support.' },
