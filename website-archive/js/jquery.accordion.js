...
(function ($) {
    ...
    var defaults = {
      ...
      cssAttrsHor : { //Only use if type of accordion is horizontal
        ulWidth: 450, //Width for ul [integer/string]. If you specify string 'responsive' it will take full width of parent container
        liWidth : 40, //Width for li [integer]
        liHeight : 230, //Height for li [integer]
      ...
      autoPlaySpeed : 5000 //By Default autoPlay speed is set at 3000ms [integer]
    },
